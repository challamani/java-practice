package com.core_java_practice.standalone.order;
...
import com.core_java_practice.standalone.order.model.OrderDetails;
import com.core_java_practice.standalone.order.model.OrderItem;
import com.core_java_practice.standalone.order.model.Product;
import com.core_java_practice.standalone.order.model.ProductInventory;
import com.core_java_practice.standalone.order.model.User;
...
public class OrderManager {
	...
	private OrderManager(){
		...
		usersRepo = new HashMap<String,User>(){
			{
				put("mani.challa1990@gmail.com",
						new User("mani.challa1990@gmail.com", "Mani Challa", "27", "Bangalore BTM", "9703779308", "560120", "changeit"));
				put("sai@gmail.com",
						new User("sai.raj@gmail.com", "Sai", "24", "Bangalore BTM", "9703779308", "560120", "changeit"));
				put("ravi369@gmail.com",
						new User("ravi@gmail.com", "ravi Surname", "25", "Koramangal", "9703779308", "560120", "Nothing"));
			}
		};
