package com.javacorepractice.standalone;
...
import com.javacorepractice.standalone.order.NoStockException;
import com.javacorepractice.standalone.order.OrderManager;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		if(mainObject.doLogin(userId,password)){
			...
			System.out.println("Invalid user details in SaiSree database");
		}
	}
