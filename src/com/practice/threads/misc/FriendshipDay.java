...
public class FriendshipDay {

    public static void main(String[] args) {
        char[] chars = "HAPPY FRIENDSHIP DAY".toCharArray();
        new FriendshipThread(chars, 20, 10)
                .start();
    }
}

class FriendshipThread extends Thread implements MyTechHub {

    private final char[] displayChars;
    private final int column;
    private final int row;

    public FriendshipThread(char[] displayChars,
                            int row,
                            int column) {
